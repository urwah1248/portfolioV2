    ...
    <div>
      <div className="hidden left-fixedbar md:block fixed w-6 h-[400px] bottom-0 left-5">
        <div className="icons flex flex-col gap-4">
          ...
          <a
            href="https://www.linkedin.com/in/muhammad-urwah/"
            target="_blank"
            rel="noreferrer"
          >
            <IconLinkedin />
          ...
          <a
            href="https://twitter.com/urwah1248"
            target="_blank"
            rel="noreferrer"
          >
            <IconTwitter />
      ...
      <div className="hidden right-fixedbar md:block fixed w-6 h-[400px] bottom-0 right-5">
        <div className="flex flex-col gap-4">
          <a
            className="iconhover mb-[164px] rotate-90 text-gray-400 font-mono -mr-1"
            href="mailto:urwahpatel@gmail.com"
          >
            urwahpatel@gmail.com
          </a>
